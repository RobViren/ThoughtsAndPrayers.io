          ...
          <div class="box">
            <h1 class="title" id="about-text">About</h1>
  					<div class="box">
							...
							<h1>Process</h1>
							<p>{'The chairity of the week will be selected by a google form. The donation will go to the selected chairty at the end of the week. The payments will go through a service called http://makemydonation.org/. The results of the weeks mining will also be posted on imgur and linked'}</p>
